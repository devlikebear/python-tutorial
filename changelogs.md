...
### 🎯 전체 진행 상황
- **프로젝트 시작일**: 2024년 12월
- **현재 상태**: 초급 튜토리얼 작성 진행 중 (Chapter 6 완료)
- **완료된 단계**: 기본 프로젝트 구조 설정, 초급 Chapter 1-6 완료
...
- [x] Chapter 3: 문자열 다루기 ✅ 2024-12-19 완료
- [x] Chapter 4: 연산자와 표현식 ✅ 2024-12-19 완료
- [x] Chapter 5: 입력과 출력 ✅ 2024-12-19 완료
- [x] Chapter 6: 조건문 (if문) ✅ 2024-12-19 완료
